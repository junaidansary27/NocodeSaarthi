...
const testimonials: Testimonial[] = [
  {
    ...
    review: 'Nocode Saarthi delivered exactly what we needed. Their AI automation expertise and development quality helped us launch faster while improving our internal business operations.',
    rating: 5,
  },
  {
    name: 'Sophia Bennett',
    ...
    review: 'The team understood our business goals from day one. They built a scalable solution with excellent communication and timely delivery.',
    rating: 5,
  },
  {
    name: 'Michael Reynolds',
    role: 'CEO',
    company: 'BrightScale Digital',
    image: 'https://randomuser.me/api/portraits/men/75.jpg',
    review: 'Working with Nocode Saarthi was seamless. Their attention to detail, technical expertise, and commitment to quality exceeded our expectations.',
    rating: 5,
  },
  {
    ...
    review: 'From strategy to deployment, every step was handled professionally. We highly recommend Nocode Saarthi for AI and custom software development.',
    rating: 5,
  },
];
